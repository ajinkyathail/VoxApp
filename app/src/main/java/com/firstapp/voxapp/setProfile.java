...
public class setProfile extends AppCompatActivity {
    ...
    private android.widget.Button msaverprofile;
    private FirebaseAuth firebaseAuth;
    private  String name;
    private FirebaseStorage firebaseStorage;
    private StorageReference storageReference;
    private String ImageUriAccssToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msaverprofile = findViewById(R.id.saveProfile);
        ...
        msaverprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ImageUriAccssToken = uri.toString();
    ...
    private void sendDataTocloudFirestore() {
        ...
        userdata.put("image",ImageUriAccssToken);
